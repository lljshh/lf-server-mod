...
public class Rsa {
     ...
     */
    public String encryptByPublicKey(String data, String publicKeyStr) throws Exception {
        //Java原生base64解码
     ...
     * @return 解密后的字符串
     */
    public String decryptByPrivateKey(String data, String privateKeyStr) throws Exception {
        //Java原生base64解码
    ...
    public String getPubilcKey() {
        return Key.get("publicKeyStr");
    }
    public String getPrivateKey() {
        return Key.get("privateKeyStr");
    }
}
